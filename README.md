...
5ステージCLOSは大規模なネットワーク構成なのに　<span style="font-size: 200%;">画面上では小さな構成しか表現できない</span>　ことにモヤモヤしますよね。
...
このような　<span style="font-size: 200%;">大規模なネットワーク構成を１画面に収めたい</span>　というのが今回の趣旨です。
